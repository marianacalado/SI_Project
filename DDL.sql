...
INSERT INTO Product (id_product, name, unit_price, description, category_id, brand_id) VALUES (16, 'Evacol, 7,5 mg/mL-30 mL x 1 sol oral gta, 7.5 mg/ml x 1 sol oral gta', 5.95 ,'Medicamento indicado no tratamento da obstipação (prisão de ventre).Evacol é um medicamento não sujeito a receita médica, indicado em casos de obstipação e em situações que requerem defecação facilitada.', 3 , 12 );
INSERT INTO Product (id_product, name, unit_price, description, category_id, brand_id) VALUES (17, 'Doce Alívio x 30 comp', 6.95 ,'Medicamento indicado no tratamento de obstipações de diversas etiologias ou antes de exame ou cirurgia intestinal.', 3 , 12 );
INSERT INTO Product (id_product, name, unit_price, description, category_id, brand_id) VALUES (18, 'Septolete Duo, 3/1 mg x 16 pst', 6.95 ,'Medicamento indicado no tratamento de obstipações de diversas etiologias ou antes de exame ou cirurgia intestinal.', 3 , 13 );
--suplementos ate saude animal --categoria orto não vai ter produtos!!!
INSERT INTO Product (id_product, name, unit_price, description, category_id, brand_id) VALUES (19, 'Dulcosoft Pó Solulçao Oral Saquetas 10 G x20', 13.95 ,'Pó para solução oral indicado para amolecer as fezes duras e secas de forma a facilitar a evacuação.', 4 , 12 );
INSERT INTO Product (id_product, name, unit_price, description, category_id, brand_id) VALUES (20, 'Durex Natural Plus Preservativo', 3.95 ,'Preservativos, fáceis de colocar que que proporcionam conforto ao usar.', 5 , 12 );
INSERT INTO Product (id_product, name, unit_price, description, category_id, brand_id) VALUES (21, 'Máscaras Cirúrgicas IIR Criança Freedom Azul Caixa x50', 3.99 ,'Máscaras cirúrgicas tipo IRR de criança.Embalagem com 50 unidades.', 6 , 13 );
